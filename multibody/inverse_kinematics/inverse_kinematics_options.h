...
namespace drake {
    namespace multibody {
        ...
        protected:
            void setDefaultParams(MultibodyPlant<double> *robot);

        public:
            explicit InverseKinematicsOptions(MultibodyPlant<double> *robot);

            InverseKinematicsOptions(const InverseKinematicsOptions &rhs);

            ~InverseKinematicsOptions(void);

            MultibodyPlant<double> *getRobotPtr() const;
            ...
            void updateRobot(MultibodyPlant<double> *new_robot);
